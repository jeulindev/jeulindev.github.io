...
function usbManager(device)
{
	...
	this.resetOutputs = function()
	{
		...
		if (oUSB.readStep==1)
			device.read();
		device.write([0x00, 0x65, 0x81, 0, 0, 0x00, 0x00, 0x00, 0x00]);
		device.write([0x00, 0x65, 0x82, 0, 0, 0x00, 0x00, 0x00, 0x00]);
		device.write([0x00, 0x65, 0x83, 0, 0, 0x00, 0x00, 0x00, 0x00]);
		device.write([0x00, 0x65, 0x84, 0, 0, 0x00, 0x00, 0x00, 0x00]);
		device.write([0x00, 0x65, 0x85, 0, 0, 0x00, 0x00, 0x00, 0x00]);
		device.write([0x00, 0x65, 0x86, 0, 0, 0x00, 0x00, 0x00, 0x00]);	
	}
	oUSB 					= this;
